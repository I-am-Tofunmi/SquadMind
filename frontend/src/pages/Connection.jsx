  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col font-outfit relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-6 relative z-10">
        <div className="w-full max-w-[480px] bg-white rounded-[32px] md:rounded-[40px] shadow-2xl shadow-[#001f3f]/5 border border-slate-50 p-8 md:p-12 flex flex-col items-center min-h-[500px] justify-center">
          ...
          {isAnalyzing ? (
            <div className="w-full flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <div className="w-full bg-slate-50 h-3 rounded-full overflow-hidden mb-4 border border-slate-100">
                <div 
                  className="h-full bg-[#001f3f] transition-all duration-300 ease-out"
                  style={{ width: `${progress}%` }}
                ></div>
              </div>
              <div className="flex justify-between w-full">
                <span className="text-[10px] font-bold text-[#001f3f] uppercase tracking-widest">{progress}% Complete</span>
            ...
            <>
              ...
              <button 
                onClick={handleOAuth}
                className="w-full bg-[#001f3f] hover:bg-[#002b55] text-white font-bold py-4.5 rounded-2xl flex items-center justify-center gap-3 transition-all mb-8 shadow-xl shadow-[#001f3f]/10 cursor-pointer text-base active:scale-95 opacity-90 hover:opacity-100"
              >
              ...
              >
                ...
                <button 
                  ...
                  className="w-full bg-white border-2 border-[#001f3f] text-[#001f3f] font-bold py-4 rounded-2xl flex items-center justify-center hover:bg-slate-50 transition-all mb-10 text-base cursor-pointer active:scale-95 disabled:opacity-70"
                >
                  {isConnecting ? (
