    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col font-outfit relative overflow-hidden">
      ...
      {showToast && (
        <div className="fixed top-8 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-top-4">
          <div className="bg-[#001f3f] text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 border border-white/10">
      ...
      <header className="w-full flex justify-between items-center py-6 px-10 relative z-10">
        ...
        <div className="flex items-center gap-2 bg-white px-4 py-1.5 rounded-full border border-slate-100 shadow-sm cursor-pointer">
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-6 relative z-10">
        <div className="w-full max-w-[480px] bg-white rounded-[32px] md:rounded-[40px] shadow-2xl shadow-[#001f3f]/5 border border-slate-100 p-8 md:p-12 flex flex-col items-center min-h-[500px] justify-center">
          ...
          {isAnalyzing ? (
            <div className="w-full flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
              ...
              <h2 className="text-2xl font-extrabold text-[#001f3f] text-center mb-4 tracking-tight">
            ...
            <>
              <div className="w-16 h-16 bg-[#001f3f]/5 rounded-3xl flex items-center justify-center mb-8 shadow-inner">
              ...
              <button
                onClick={handleOAuth}
                className="w-full bg-[#001f3f] hover:bg-[#002b55] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all mb-8 shadow-xl shadow-[#001f3f]/10 cursor-pointer text-base active:scale-95"
              >
                <Key className="w-4 h-4 text-[#E8762E]" />
              ...
              {error && (
                <div className="w-full mb-6 p-4 bg-red-50 border border-red-100 rounded-2xl text-red-600 text-xs font-bold text-center">
                  {error}
                </div>
              )}
              ...
              <form className="w-full" onSubmit={handleConnect}>
                <div className="w-full space-y-6 mb-10">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block ml-1">Squad API Key</label>
                    <input
                      type="text"
                      required
                      value={publicKey}
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block ml-1">Secret Key</label>
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••••••••••"
                        className={`w-full border border-slate-100 bg-slate-50 rounded-2xl px-5 py-4 pr-12 text-sm text-slate-900 focus:ring-2 focus:ring-[#E8762E]/20 outline-none placeholder:text-slate-300 transition-all font-medium ${!showPassword ? 'tracking-widest' : ''}`}
                      />
                      <button
                        type="button"
