  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col font-outfit text-slate-900 overflow-x-hidden">
      ...
      <nav className="w-full h-20 bg-primary flex items-center justify-between px-6 md:px-20 relative z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="bg-[#E8762E] text-white px-5 md:px-6 py-2.5 rounded-lg text-[13px] font-bold hover:bg-[#E8762E]/90 transition-all cursor-pointer shadow-lg"
          >
            Get Started
          </button>
          <button 
      ...
      <section className="pt-16 md:pt-24 pb-20 md:pb-32 px-6 flex flex-col items-center text-center">
        <div className="inline-flex items-center px-4 py-1.5 bg-[#fff4ed] rounded-full mb-8">
              ...
              <div className="flex h-[400px] md:h-[550px] overflow-hidden">
                 ...
                 <div className="w-16 md:w-56 bg-[#001f3f] h-full p-4 md:p-8 space-y-8 shrink-0 flex flex-col">
                    ...
                    <div className="space-y-4">
                       {[
                         ...
                         <div key={i} className="flex items-center gap-3">
                            <div className={`w-4 h-4 rounded-md ${item.active ? 'bg-[#E8762E]' : 'bg-white/10'}`}></div>
                    ...
                    <div className="mt-auto space-y-4">
                       ...
                       <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-lg bg-[#E8762E]"></div>
                 ...
                 <div className="flex-1 bg-white p-6 md:p-10 flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                       {[
                         { title: 'REVENUE', val: '₦342k', trend: '+12%' },
                         { title: 'TXNS', val: '84', bar: true },
                         { title: 'BEST DAY', val: 'Friday' },
                         { title: 'HEALTH', val: '78/100' }
                       ].map((card, i) => (
                         <div key={i} className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm space-y-4">
                            ...
                            {card.bar && <div className="w-full h-1.5 bg-slate-100 rounded-full"><div className="w-[72%] h-full bg-[#E8762E] rounded-full"></div></div>}
                         </div>
                       ))}
                    </div>
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-4">
                  <div className="w-5 h-5 rounded-full bg-orange-50 flex items-center justify-center">
                    <CheckCircle2 className="w-3 h-3 text-[#E8762E]" />
                  </div>
